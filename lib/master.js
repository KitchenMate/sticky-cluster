  ...
  function serverCreate () {
    ...
    return require('net')
      .createServer({ pauseOnConnect: true }, function (connection) {
        ...
        var signature = connection.headers['x-forwarded-for'] || (connection.remoteAddress + ':' + connection.remotePort);
        ...
        // choose a worker
        var key = connection.headers['x-forwarded-for'] || connection.remoteAddress || ''
        var index = hash(key) % CONCURRENCY;
